    ...
    return (
        <div className="space-y-4 sm:space-y-6 px-1 sm:px-2 font-sans pb-24 text-slate-800 dark:text-slate-100 animate-in fade-in duration-500 relative">
            ...
            <Dialog open={isManualModalOpen} onOpenChange={(open) => {setIsManualModalOpen(open); if(!open){setUnlockedWallets({}); setCuadreData({});}}}>
                <DialogContent className="w-[95vw] max-w-md rounded-[2.5rem] p-6 sm:p-8 border-none bg-white dark:bg-[#1c1c1e] shadow-2xl custom-scrollbar max-h-[90vh] overflow-y-auto">
