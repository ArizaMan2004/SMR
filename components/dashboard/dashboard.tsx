...
// Iconos
// 🔑 Se añaden Image, Handshake, Stamp para los nuevos botones de assets
import { Plus, DollarSign, Users, Upload, Trash2, LogOut, Image, Handshake, Stamp } from "lucide-react" 
...
import { 
    ...
    getFirmaBase64, setFirmaBase64, // NUEVOS
    getSelloBase64, setSelloBase64  // NUEVOS
...
// --- TIPOS ---
type ActiveView = "orders" | "clients" | "products" | "sales" | "statistics" | "reports"
...
export default function Dashboard() {
  ...
  const [firmaBase64, setFirmaBase64State] = useState<string | undefined>(undefined); // NUEVO
  const [selloBase64, setSelloBase64State] = useState<string | undefined>(undefined); // NUEVO

  // --- LÓGICA DE DATOS Y EFECTOS ---
  useEffect(() => {
    if (!user || (activeView !== "orders" && activeView !== "clients")) return
    
    // 🔑 CARGA INICIAL DE ASSETS (Logo, Firma y Sello)
    getLogoBase64().then(setPdfLogoBase64);
    setFirmaBase64State(getFirmaBase64()); // Sincrónico de localStorage
    setSelloBase64State(getSelloBase64()); // Sincrónico de localStorage
  ...
  // ... (funciones handleDeleteOrden, handleUpdateStatus, handleEditOrden, handleEditPayment, handlePaymentUpdate se mantienen) ...
  ...
  // 🔑 FUNCIÓN PARA GENERAR EL PDF (Punto de integración clave)
  ...
  const navItems = [
    { id: 'orders', label: 'Órdenes de Trabajo', icon: <DollarSign className="w-5 h-5" /> },
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
            ...
            <div className="p-4 lg:p-8 overflow-y-auto">
              <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    {/* Contenedor de Assets (Se usa flex-wrap para responsividad) */}
                    <div className="flex flex-wrap gap-4">
                        
                        {/* 1. Botones de Logo PDF (Se actualiza para usar 'icon' en vez de 'sm') */}
                    ...
                    {/* Botón de Nueva Orden (Se mantiene) */}
                ...
                <OrdersTable
                  ...
                  // 🔑 NUEVO: PASAMOS LA FUNCIÓN GENERADORA CON LOS NUEVOS ASSETS
          ...
          {(activeView === "products" || activeView === "sales" || activeView === "statistics" || activeView === "reports") && (
            <div className="p-4 lg:p-8">
              <div className="max-w-7xl mx-auto">
